...
#define BALL_IN_RANGE_COLOR	3 //2
...
*/
	...
	*/
	while(1){
		printf("%i, ", distance(distanceS,time));
	}
	//grab(middleM);
	...
	move(leftM, rightM, 100000, 0);  //for the first streight walk
...
printf("Go long side \n");
	...
	move(leftM, rightM, 5500, 350);//19500
...
// MOVE TO 3 POS
	...
	//move(leftM, rightM, (2*4150), 250); //Exactly 50 cm
	move(leftM, rightM, 6700,300);   //long side second to third
